...
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '+9233403397046 : process.env.OWNER_NUMBER,   +923167118815
ONLY_GROUP: process.env.ONLY_GROUP === undefined ? 'https://chat.whatsapp.com/J2blP3TAoOm3cjYbbkfDSj' : process.env.ONLY_GROUP,
ONLY_ME: process.env.ONLY_ME === undefined ? 'PEGASUS' : process.env.ONLY_ME,
